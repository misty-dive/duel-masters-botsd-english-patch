#!/usr/bin/env python3
"""Build the v1.1 Records, Options, Deck Builder, and Deck Stats UI cleanup.

The script edits only the targeted archive members and keeps their binary layout constraints intact."""
