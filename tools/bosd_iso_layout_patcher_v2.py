#!/usr/bin/env python3
"""Patch translated files into the retail PS2 ISO while preserving ISO9660 layout rules.

Same-size files are replaced in place; enlarged files are appended and their directory records are retargeted."""
